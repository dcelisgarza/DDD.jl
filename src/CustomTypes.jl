...
"""
```
arbRot3D(abc::Vector{<:Real}, uvw::Vector{Real}, vec::Vector{<:Real}, θ::Real)
```
Rotate point (x,y,z) about the line with direction vector <u,v,w> that crosses the point (a,b,c) by the angle θ.
"""
function arbRot3D(
    abc::Vector{<:Real},
    uvw::Vector{Real},
