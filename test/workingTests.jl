...
compStruct(network2, network, verbose = true)
...
fig = plotNodes(regularCuboidMesh, network2, m = 1,
    l = 3,
    linecolor = :blue,
    marker = :circle,
    markercolor = :blue,
    legend = false,)
fig.n == numNode + 6
network2.nodeVel[:, 1:network2.numNode[1]] .= rand(3, network2.numNode[1])
